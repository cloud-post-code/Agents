...
class ProductImage(Base):
    """One row per image attached to a product. image_order controls display order."""
...
class Product(Base):
    ...
    # Primary/thumbnail image shortcut — canonical store is the product_images table
