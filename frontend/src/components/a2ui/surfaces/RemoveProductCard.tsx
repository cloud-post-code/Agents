...
export function RemoveProductCard({ id, name = "this product", sku }: RemoveProductCardProps) {
  const { token } = useAuth();
  ...
  return (
    <div className="rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm w-full max-w-sm">
      ...
      <div className="bg-white rounded-lg border border-red-100 px-3 py-2 mb-3 space-y-0.5">
